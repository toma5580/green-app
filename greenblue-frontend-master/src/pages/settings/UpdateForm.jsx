...
const UpdateForm = (props) => {
  ...
  return (
    <div>
      ...
      <div className="card card-side bg-base-100 shadow mt-5">
        <div className="card-body ">
          <h1 className="card-title">Contact Infomation</h1>
          <div class="grid md:grid-cols-1 md:gap-1 ">
      ...
      <div className="card card-side bg-base-100 shadow mt-5">
        <div className="card-body ">
          <h1 className="card-title">Secuity</h1>
          <div class="grid md:grid-cols-1 md:gap-1 ">
            <label className="label">
              <span className="label-text text-bold">New Secure Password</span>
            </label>
            ...
            <button
              className={`btn btn-success ${loading && "loading"} w-full`}
